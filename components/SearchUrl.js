    ...
    <form onSubmit={handleSubmit(onSubmit,onError)}>
      <FormControl isInvalid={errors.url}>
         <Flex flexDirection={["column","row"]} justifyContent="center" width={["100%","85%"]} mx="auto" gap={4} >
                  ...
                  <Button type='submit'  onClick={(e)=>{ search_click(e,getValues('url')) }}  rightIcon={<ArrowForwardIcon />} colorScheme='red' borderRadius="none" variant='solid'> Start</Button>
          </Flex>
          <FormErrorMessage  width="max-content" mx="auto" mt={3} >Pleas make sure your input match this pattern https://www.youtube.com/watch?v=.....</FormErrorMessage>
      </FormControl>
    </form>
